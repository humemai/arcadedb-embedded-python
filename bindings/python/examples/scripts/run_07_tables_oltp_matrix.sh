...
# Dataset Tier  Transactions  Batch   Memory
# Tiny          10,000        1,000   1GB
# Small         50,000        2,500   2GB
# Medium        100,000       5,000   4GB
# Large         250,000       10,000  8GB
# X-Large       1,000,000     25,000  32GB
...
DBS_RAW="duckdb,sqlite,postgresql,arcadedb_sql"
...
for ((run = 1; run <= RUNS; run++)); do
    for db in "${DBS[@]}"; do
        ...
        target_dir="my_test_databases/${dataset_slug}_tables_oltp_${db}_mem${mem_tag}_${run_label}"
