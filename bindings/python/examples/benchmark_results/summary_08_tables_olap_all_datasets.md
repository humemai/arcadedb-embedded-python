...
| db | run_label | seed | runs | threads | mem_limit | query_runs | query_order | status | load_s | index_s | query_s | rss_peak_mib | du_mib |
|---|---|---|---:|---:|---|---:|---|---|---:|---:|---:|---:|---:|
| arcadedb_sql | sweep08_t01_r01_arcadedb_sql_s00000_m8g | 0 | 1 | 1 | 8g | 10 | shuffled | success | 721.757 | 1,397.427 | 1,778.791 | 6,792.742 | 8,908.938 |
| arcadedb_sql | sweep08_t04_r01_arcadedb_sql_s00000_m8g | 0 | 1 | 4 | 8g | 10 | shuffled | success | 682.592 | 1,403.51 | 1,322.387 | 5,961.371 | 8,908.941 |
| arcadedb_sql | sweep08_t08_r01_arcadedb_sql_s00000_m8g | 0 | 1 | 8 | 8g | 10 | shuffled | success | 680.008 | 1,411.462 | 1,324.07 | 5,939.211 | 8,908.938 |
| duckdb | sweep08_t01_r01_duckdb_s00002_m8g | 2 | 1 | 1 | 8g | 10 | shuffled | success | 484.272 | 11.319 | 1.334 | 6,557.051 | 18,354.637 |
| duckdb | sweep08_t04_r01_duckdb_s00002_m8g | 2 | 1 | 4 | 8g | 10 | shuffled | success | 456.705 | 10.336 | 0.498 | 6,492.137 | 18,348.895 |
| duckdb | sweep08_t08_r01_duckdb_s00002_m8g | 2 | 1 | 8 | 8g | 10 | shuffled | success | 438.186 | 9.235 | 0.309 | 6,984.016 | 18,350.641 |
| postgresql | sweep08_t01_r01_postgresql_s00003_m8g | 3 | 1 | 1 | 8g | 10 | shuffled | success | 769.943 | 52.57 | 46.508 | 3,495.68 | 16,129.785 |
| postgresql | sweep08_t04_r01_postgresql_s00003_m8g | 3 | 1 | 4 | 8g | 10 | shuffled | success | 672.932 | 43.453 | 34.748 | 3,491.449 | 16,129.844 |
| postgresql | sweep08_t08_r01_postgresql_s00003_m8g | 3 | 1 | 8 | 8g | 10 | shuffled | success | 655.053 | 41.755 | 33.196 | 3,509.691 | 16,129.832 |
| sqlite | sweep08_t01_r01_sqlite_s00001_m8g | 1 | 1 | 1 | 8g | 10 | shuffled | success | 216.601 | 39.863 | 25.365 | 847.82 | 8,921.906 |
| sqlite | sweep08_t04_r01_sqlite_s00001_m8g | 1 | 1 | 4 | 8g | 10 | shuffled | success | 212.829 | 36.267 | 23.857 | 848.617 | 8,921.91 |
| sqlite | sweep08_t08_r01_sqlite_s00001_m8g | 1 | 1 | 8 | 8g | 10 | shuffled | success | 219.932 | 50.293 | 25.463 | 842.527 | 8,921.91 |
...
| db | run_label | seed | runs | threads | mem_limit | query_runs | query_order | status | load_s | index_s | query_s | rss_peak_mib | du_mib |
|---|---|---|---:|---:|---|---:|---|---|---:|---:|---:|---:|---:|
| arcadedb_sql | sweep08_t01_r01_arcadedb_sql_s00000_m2g | 0 | 1 | 1 | 2g | 10 | shuffled | success | 4.774 | 2.13 | 3.197 | 239.438 | 33.398 |
| duckdb | sweep08_t01_r01_duckdb_s00002_m2g | 2 | 1 | 1 | 2g | 10 | shuffled | success | 1.857 | 0.105 | 0.051 | 136.797 | 65.793 |
| postgresql | sweep08_t01_r01_postgresql_s00003_m2g | 3 | 1 | 1 | 2g | 10 | shuffled | success | 1.076 | 0.053 | 0.096 | 205.031 | 132.801 |
| sqlite | sweep08_t01_r01_sqlite_s00001_m2g | 1 | 1 | 1 | 2g | 10 | shuffled | success | 0.673 | 0.065 | 0.054 | 95.66 | 30.832 |

### Per-query latency (aggregated)

| db | threads | query | samples | elapsed_mean_ms | elapsed_p95_ms | row_counts | hash_stable_within_db |
|---|---:|---|---:|---:|---:|---|---|
| arcadedb_sql | 1 | most_commented_posts | 10 | 26.292 | 65.277 | 10 | True |
| arcadedb_sql | 1 | post_type_counts | 10 | 36.72 | 91.961 | 5 | True |
| arcadedb_sql | 1 | posthistory_by_type | 10 | 49.904 | 106.296 | 22 | True |
| arcadedb_sql | 1 | postlinks_by_type | 10 | 38.696 | 119.204 | 2 | True |
| arcadedb_sql | 1 | top_answers_by_score | 10 | 32.26 | 77.374 | 10 | True |
| arcadedb_sql | 1 | top_badges | 10 | 26.169 | 67.843 | 2 | True |
| arcadedb_sql | 1 | top_questions_by_score | 10 | 25.017 | 68.357 | 10 | True |
| arcadedb_sql | 1 | top_tags_by_count | 10 | 1.398 | 2.571 | 10 | True |
| arcadedb_sql | 1 | top_users_by_reputation | 10 | 49.562 | 128.989 | 10 | True |
| arcadedb_sql | 1 | votes_by_type | 10 | 32.967 | 87.913 | 10 | True |
| duckdb | 1 | most_commented_posts | 10 | 0.531 | 0.859 | 10 | True |
| duckdb | 1 | post_type_counts | 10 | 0.331 | 0.361 | 5 | True |
| duckdb | 1 | posthistory_by_type | 10 | 0.333 | 0.379 | 22 | True |
| duckdb | 1 | postlinks_by_type | 10 | 0.341 | 0.451 | 2 | True |
| duckdb | 1 | top_answers_by_score | 10 | 0.707 | 1.022 | 10 | True |
| duckdb | 1 | top_badges | 10 | 0.38 | 0.464 | 2 | True |
| duckdb | 1 | top_questions_by_score | 10 | 0.72 | 0.993 | 10 | True |
| duckdb | 1 | top_tags_by_count | 10 | 0.265 | 0.407 | 10 | True |
| duckdb | 1 | top_users_by_reputation | 10 | 0.824 | 0.928 | 10 | True |
| duckdb | 1 | votes_by_type | 10 | 0.342 | 0.415 | 10 | True |
| postgresql | 1 | most_commented_posts | 10 | 1.522 | 1.813 | 10 | True |
| postgresql | 1 | post_type_counts | 10 | 1.098 | 1.472 | 5 | True |
| postgresql | 1 | posthistory_by_type | 10 | 1.375 | 2.014 | 22 | True |
| postgresql | 1 | postlinks_by_type | 10 | 0.919 | 1.111 | 2 | True |
| postgresql | 1 | top_answers_by_score | 10 | 1.114 | 1.662 | 10 | True |
| postgresql | 1 | top_badges | 10 | 0.969 | 1.056 | 2 | True |
| postgresql | 1 | top_questions_by_score | 10 | 0.877 | 1.143 | 10 | True |
| postgresql | 1 | top_tags_by_count | 10 | 0.191 | 0.233 | 10 | True |
| postgresql | 1 | top_users_by_reputation | 10 | 0.235 | 0.565 | 10 | True |
| postgresql | 1 | votes_by_type | 10 | 0.898 | 1.03 | 10 | True |
| sqlite | 1 | most_commented_posts | 10 | 0.526 | 0.537 | 10 | True |
| sqlite | 1 | post_type_counts | 10 | 0.266 | 0.275 | 5 | True |
| sqlite | 1 | posthistory_by_type | 10 | 0.327 | 0.5 | 22 | True |
| sqlite | 1 | postlinks_by_type | 10 | 0.275 | 0.304 | 2 | True |
| sqlite | 1 | top_answers_by_score | 10 | 1.769 | 2.176 | 10 | True |
| sqlite | 1 | top_badges | 10 | 0.313 | 0.336 | 2 | True |
| sqlite | 1 | top_questions_by_score | 10 | 1.317 | 1.645 | 10 | True |
| sqlite | 1 | top_tags_by_count | 10 | 0.051 | 0.063 | 10 | True |
| sqlite | 1 | top_users_by_reputation | 10 | 0.033 | 0.044 | 10 | True |
| sqlite | 1 | votes_by_type | 10 | 0.283 | 0.309 | 10 | True |
