...
with arcadedb.create_database(db_path) as db:
    ...
    print("   💡 NULL values used for optional fields (due_datetime, cost, etc.)")
    print("   💡 Python uuid4() generates unique task IDs")
    print(f"   ⏱️  Time: {time.time() - step_start:.3f}s")
    print()
    ...
    print("   📋 All tasks (with automatic type conversion):")
    ...
    if not tasks:
        ...
        print(f"      💡 Used to_list() for efficient bulk conversion")

    print()

    # Query for tasks with NULL values (no deadline)
    print("   ⏰ Tasks without deadlines (due_datetime IS NULL):")
    ...
    if count == 0:
        ...
        print(f"      💡 Found {count} task(s) with NULL deadline")

    print()

    # Query for tasks with NULL cost
    print("   💰 Tasks without cost estimate (cost IS NULL):")
    ...
    if count == 0:
        ...
        print(f"      💡 Found {count} task(s) with NULL cost")
    ...
    print("   ✅ Marked 'Buy groceries' as completed and set actual cost")
    print()
    ...
    print("   ✅ Cleared cost and time estimates for 'Call dentist' (set to NULL)")
    print()

    # Verify the updates
    print("   📊 Updated task list (with NULL handling):")
    ...
    print("      💡 Using new count_type() method (faster than COUNT query)")
    print()
    ...
    print("   💡 New ResultSet features demonstrated:")
    print("      • to_list() - bulk conversion to list of dicts")
    print("      • first() - get first result or None")
    print("      • count_type() - efficient record counting")
    print("      • Automatic type conversion (no more Java objects!)")
...
print("   • CRUD operations (Document API + SQL)")
