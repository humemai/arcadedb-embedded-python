...
def test_index(
    ...
    for i, query_vec in enumerate(queries):
        ...
        # Explicitly sort results to ensure correct order
        # Euclidean: Lower score (distance) is better -> Ascending
        # Cosine: Higher score (similarity) is better -> Descending
        # NOTE: The library now handles sorting correctly based on the metric.
        # if metric == "euclidean":
            ...
            for m in m_values:
                for ef in ef_values:
                    ...
                    for k in k_values:
                        ...
                        j_rec, j_std, j_hit, j_hit_std, j_lat, j_lat_std, j_bld = (
                            None,
                            None,
                            None,
                            None,
                        ...
                        h_rec, h_std, h_hit, h_hit_std, h_lat, h_lat_std, h_bld = (
                            None,
                            None,
                            None,
                            None,
