...
- Keeps removed upstream Java/Maven workflows from being reintroduced: `.github/workflows/mvn-test.yml`, `.github/workflows/mvn-deploy.yml`, `.github/workflows/mvn-release.yml`, and `.github/workflows/license-compliance.yml`
