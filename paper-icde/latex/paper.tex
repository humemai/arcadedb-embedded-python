...
demanded. Co-author input needed here. Third-party academic adoption:
DatAasee~\cite{himpe2024dataasee}, a metadata catalog for research libraries
built on ArcadeDB (multi-model documents+graph use case); co-author "why we
chose it" paragraph goes here or in Lessons.}
