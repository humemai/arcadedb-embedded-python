...
def main() -> int:
    ...
    ap.add_argument("--page-only", action="store_true",
                    help="accepted and ignored: the page is the only mode since 2026-09-11, "
                         "and claims_check is a helper library, not a gate")
    ...
    # only mode (the flag stays accepted and is a no-op). GATES is the gate
    # list; claims_check is not in it.
