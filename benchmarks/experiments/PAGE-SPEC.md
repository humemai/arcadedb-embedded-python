...
| `l2` | Graph OLTP | ArangoDB, ArcadeDB (embedded), ArcadeDB (server), DuckPGQ, FalkorDB, LadybugDB, Memgraph, Neo4j, SurrealDB (embedded), SurrealDB (server) | SF1 (11k people), SF10 (73k people) | point p50 ms, point p99 ms, 1-hop p50 ms, 1-hop p99 ms, 2-hop p50 ms, 2-hop p99 ms, write p50 ms, write p99 ms, ingest vertices+edges/s, ingest total s, peak memory GiB, disk GiB |
