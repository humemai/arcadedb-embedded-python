# Experimental campaign — July 2026 (COMPLETE)

Status: **all seven lanes data-complete on mini** as of 2026-07-22.
Raw data: mini, under this directory's `experiments/results/`
(runs.jsonl + l4_tsbs.jsonl), archived on mini at
`~/archives/campaign-2026-07-22-{results,queue-logs}.tar.gz`; laptop
